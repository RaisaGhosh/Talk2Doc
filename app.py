...
with st.sidebar:
    ...
    st.write('Built by Accenture AI Training Batch')
...
def main():
    ...
    if pdf is not None:
        ...
        #USINF FREE HUGGING FACE EMBEDDINGS
        ...
        #st.write(vectorStore.similarity_search(query="What is LeNet",k=5))
        # st.write("done")
